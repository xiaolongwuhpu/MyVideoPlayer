package com.longwu.ijkplayer.utlis.permission;
...
//            if (ContextCompat.checkSelfPermission(getActivity(object), Manifest.permission.WRITE_EXTERNAL_STORAGE)
        ...
        for (Method method:methods){
            ...
            if(failMethod != null){
                ...
                if(methodCode == requestCode){
                    ...
                    Toast.makeText((Activity)reflectObject,"拒绝了",Toast.LENGTH_LONG).show();
                    executeMethod(reflectObject,method);
                }
            }
        }
